...
public class AddressBook {
     ...
     * Keyword matching is case insensitive (forced keywords and wordsInName to lowercase).
     *
     * @param commandArgs full command args string from the user
     * @return feedback display message for the operation result
     */
    ...
    /**
     * Returns all persons in the address book, sorted alphabetically.
     */
    private static ArrayList<String[]> getAllPersonsInAddressBookSorted() {
        ArrayList<String[]> tempSortArrayList = ALL_PERSONS;
        Collections.sort(tempSortArrayList, Comparator.comparing((String[] a1) -> a1[0]));
        return tempSortArrayList;
    }
